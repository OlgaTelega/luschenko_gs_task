...
function f2() {
    alert(document.querySelector('.b-2').value);
}
...
// Task 3
// Создайте p.p-3 - при нажатии на него выводите alert 
// с номером задачи.
//let a = document.querySelector('.p-3').value;
function f3() {
    // alert(document.querySelector('.p-3'));
    // console.log(document.getElementsByTagName('p'));
    // console.log(document.querySelector('.p-3').outerText);
    // alert(document.querySelector('.p-3').outerText);
    alert(3);
...
//checkbox выбран и false если не выбран. Вывод везде в задачах, где не указано другое, осуществляется в div.out-номер задачи. 
...
// Task 7.
// Создайте input(password).i-7 и button.b-7 - при нажатии на кнопку выводите в div.out-71 value прописанное в input. В .out-72 выводите 1 
//если длина пароля больше или равна 6 или 0 если меньше. Для подсчета количества символов в строке используйте length.
...
function f8() {
   ...
   out8.innerHTML = '<input class = "i-81"><div class="out-81"></div><button class = "b-81">Кнопка</button>';
   let b81 = document.querySelector(".b-81");
   b81.onclick = f81;
}


let out81 = document.querySelector(".out-8");
function f81 () {
...
// Task 9
//Создайте один input(radio).r-9  и button.b-9 - при нажатии на button если radio.r-9 выбран (активен, checked) выводите в .out-9 - value 
//прописанное в r-9, либо 0 если не активен. 
...
// Task     11
//   Создайте input(color).i-111 и input(color).i-112- два элемента и button.b-11 - при нажатии на кнопку присвойте цвет из первого input в 
//value второго.
...
// Task 17
// Создайте select.s-17. Добавьте ему событие onchange, при наступлении которого запускается функция f17. Функция должна выводить 
//в out-17 value выбранного в select option.
...
// Task 18
// Создайте select.s-18 и input.i-18. Добавьте на select событие onchange, при наступлении которого запускается функция f18. Функция должна 
//выводить в input i-18 value выбранного в select option.
...
// Task 19
// Создайте форму. В ней input(text).i-191 и input(password).i-192 - и кнопку button.b-19. По нажатию кнопки выводите значение text и password 
//в out-19 через пробел. Обратите внимание на хитрость. Мы, кнопку сейчас повесили за пределами формы. Чуть позже мы рассмотрим почему это 
//делали.
...
// Task 20
// Создайте форму .f-20. В ней input(text) и input(password) - и кнопку button.b-20. По нажатию кнопки выводите значение из input text и 
// password в out-20 через пробел. Используйте form.elements (читать)
...
function f20(e) {
    ...
    out20.innerHTML = form.elements['username'].value + " " + form.elements['password'].value; // так можно обратиться к элементу внутри формы
