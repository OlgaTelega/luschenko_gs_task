...
//Перенос строки - br. Количество строк (итераций, 
...
// По нажатию кнопки b-9 должна запускаться функция t9, которая выводит в out-9 числа от меньшего введенного до 
//большего включительно, с шагом 1.
// Разделитель пробел. Если пользователь ввел 4 и 8  и нажал кнопку, мы получим:
//     4 5 6 7 8
...
function t11() {
    out = '';
    let r = document.querySelectorAll(".div-11");
...
function t12() {
    out = '';
    let r = document.querySelectorAll(".div-12");
    for (let i = 0; i < r.length; i++) {
        out += r[i].innerHTML + " ";
        r[i].style.background = 'orange';
    }
