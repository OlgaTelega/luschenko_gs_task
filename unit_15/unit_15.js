...
// Task 1
// Создайте set s1. Добавьте в него три элемента 'h', 'b', 'o', 'h'. Добавление
// делайте через add. Выведите в консоль получившийся набор (set) s1.
...
// элементы, которые пользователь вводит в i-2. Функция должна выводить в консоль
// s2 после каждого добавления элемента.
...
let s3 = new Set(['one', 'two', 'four']); // обратите внимание, как просто можно 
//добавить массив в набор!
...
// в наборе s4 строки введенной пользователем в i-4. Если строка есть
// - то вывести в out-4 true. Если нет - false.
...
// Task 5
//  При нажатии b-5 выполняете функцию f5. Функция должна вывести
// в out-5 количество элементов в наборе s5.
...
// Task 7
// При нажатии b-7 выполняете функцию f7. Функция должна получать
// из i-7 значение пароля и проверять, чтобы пользователь в строке
// пароля использовал не повторяющиеся символы. Если символы уникальны,
// а длина пароля больше ( строго) 6 то выводите в out-7 число 1. Если есть
// повторяющиеся символы, или длина меньше или равна 6 - то выводите 0. Для
// проверки уникальности символов используйте Set.
...
// в качестве параметра, преобразовывать его в строку, причем после каждого 
// символа строки должен быть пробел. Функция должна возвращать результирующую
// строку. 
