...
// 55 из массива a1. Возвратите это значение.
...
// Task 4
// При нажатии b-4 выполняете функцию f4. Функция должна вывести в out-4 значение 
// go из массива a4. Возвратите это значение.
...
// Task 9
// При нажатии b-9 выполняете функцию f9. Функция должна вывести в out-9 значения из 
// массива a9, которые больше нуля. Используем цикл. Вывод - через пробел.
...
//Вывод через пробел. Т.е. вы должны получить в out-10 строку 
//вида 6 5 4 8 7 13 12 11 10 9. Решаем задачу двумя циклами, без reverse.
...
// единицы из этого массива. Все действия в функции f12. Функция запускается при 
// нажатии на b12. Вывод через пробел.
...
// массив эмулирующий шахматную доску. Причем массив должен создаваться с помощью 
// циклов. Для проверки - выведите массив в консоль.
...
// Task 19
// Впишите в переменную a19 массив, который соответствует всем условиям 
// приведенным ниже ( все console.log должны дать true;
//  Т.е вы руками просто пишите массив такой, чтобы условия выполнялись.
