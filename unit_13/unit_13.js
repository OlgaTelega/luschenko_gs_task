...
// значение сохраненное под ключем two из массива a1. Возвратите это
// значение.
...
// Task 2
// При нажатии b-2 выполняете функцию f2. Функция должна вывести в
// out-2 значение hi из массива a2. Возвратите это значение.
...
// строки +' <br>'. Функция должна возвращать строку в указанном формате
// вывода.
...
// функцию f5, которая принимает массив как параметр и выводит его в 
// формате указанном в функции в указанный блок (как второй параметр).
...
//его в массив a6. После этого, с помощью функции f5 выводите массив a6 в 
//out-6.
...
//Функция должна вывести в out-9 все ключи массива a9, которые
// содержат значение, равное значению в input.i-9. Вывод через пробел.
...
// есть, и false если нет. Массив и значение передавать функции в качестве
// параметров.
...
document.querySelector('.b-10').onclick = () => {
    ...
    document.querySelector('.out-10').innerHTML = f10(a10, 20);
};


// Task 11
// При нажатии b-11 выполняете функцию f11. Функция должна получить ключ
// из i-11 и удалить запись из массива a11 с таким ключем. После этого
// вывести массив в out-11. Для вывода используйте функцию f5.
...
// Task 13
// При нажатии b-13 выполняете функцию f13. Функция должна в out-13
// выводить сумму значений массива a13 (только числа).
...
function f13() {
    let n = 0;
    for(let key in a13){
   if(typeof a13[key] == 'number') n += a13[key];
    
    }
    document.querySelector('.out-13').innerHTML = n;
}
...
// Task 17
// При нажатии b-17 выполняете функцию f17. Функция должна в
// out-17 выводить элементы name вложенных массивов в a17 для
// который age > 30. Вывод через пробел.
...
// Task 19
// При нажатии b-19 выполняете функцию f19. Функция должна в out-19 
// вывести цвет ветки станции которую пользователь ввел в i-19. Пользователь
// может вводить текст как с большой, так и с маленькой буквы. Если ветка
// не найдена - выводите пустую строку.
    ...
    for(let key in a20){
        for(let i = 0; i < a20[key].length; i++){
            for(let k = 0; k < a20[key][i].length; k++){
                if(a20[key][i][k] == 2) out += a20[key][i][0] + ' ';
            }
